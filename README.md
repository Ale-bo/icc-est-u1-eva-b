...
Se debe ordenar el arreglo de libros por el atributo **name** en orden **Ascendente** (de la A a la Z) con el metodo **BURBUJA MEJORADO**. Además, se debe realizar una búsqueda binaria para encontrar un libro con un nombre específico, ignorando mayúsculas y minúsculas en la comparación tanto para el ordenamietno como la busqueda.
...
5. **Verificar la entrega**  
    ...
    https://github.com/Ale-bo/icc-est-u1-eva-b
